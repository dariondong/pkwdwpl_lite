...
class FlutterBluetoothSerial {
  // Plugin
  static const String namespace = 'flutter_bluetooth_serial_plus';
  ...
  Future<BluetoothBondState> getBondStateForAddress(String address) async {
    return BluetoothBondState.fromUnderlyingValue(
      await _methodChannel.invokeMethod('getDeviceBondState', {
        "address": address,
      }),
    );
  }
  ...
  Future<bool?> bondDeviceAtAddress(
    ...
    return await _methodChannel.invokeMethod('bondDevice', {
      "address": address,
    });
  }
  ...
  Future<bool?> removeDeviceBondWithAddress(String address) async =>
      await _methodChannel.invokeMethod('removeDeviceBond', {
        'address': address,
      });
  ...
  Future<int?> requestDiscoverable(int durationInSeconds) async =>
      await _methodChannel.invokeMethod("requestDiscoverable", {
